...
if args.layers == 'mean':
    embedding = AlbertEmbeddings(args.model_name, layers='-1,-2,-3,-4', use_scalar_mix=True, pooling_operation="mean")
else:
    embedding = AlbertEmbeddings(args.model_name, layers=args.layers, pooling_operation="mean")
