...
parser.add_argument('--albert_name',
...
parser.add_argument('--lm_emb_save_path',
                    default='../wv/bbert.emb.pkl',
                    action='store',)

args = parser.parse_args()

albert_embedding = AlbertEmbeddings(args.albert_name, layers='-1,-2,-3,-4', use_scalar_mix=True, pooling_operation="mean")
bert_embedding = BertEmbeddings(args.bert_name, layers='-1,-2,-3,-4', use_scalar_mix=True, pooling_operation="mean")
